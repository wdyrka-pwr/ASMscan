...
create_plot(path_lstm="../results/ProteinBERT_new/visualizations/bilstm_umap_domains.csv",
            path_pbert="../results/ProteinBERT_new/visualizations/pbert_umap_domains.csv",
            score_threshold=0.5)
